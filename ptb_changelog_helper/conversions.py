...
def _convert_to_format(
    input_file: Path, output_file: Path, target_format: Literal["rst", "md", "html"]
) -> None:
    ...
    with output_file.open("w", encoding="utf-8") as file:
        file.write(getattr(changelog, f"as_{target_format}")())
...
def convert_to_rst(
    ...
    Args:
        ...
        output_file (:obj:`Path`): The path to the output file.
    """
    _convert_to_format(input_file, output_file, "rst")
...
def convert_to_html(
    ...
    Args:
        ...
        output_file (:obj:`Path`): The path to the output file.
    """
    _convert_to_format(input_file, output_file, "html")


def convert_to_md(input_file: Path, output_file: Path) -> None:
    ...
    Args:
        ...
        output_file (:obj:`Path`): The path to the output file.
    """
    _convert_to_format(input_file, output_file, "md")
