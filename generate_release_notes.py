...
from fetch_github import DEVELOPERS, REPO
...
docs_patterns = {
    cc_pattern: cc_rst_replace,
    code_pattern: code_rst_replace,
    pr_pattern: pr_rst_replace,
    channel_pattern: channel_rst_replace,
}
release_patterns = {
    cc_pattern: cc_md_replace,
    code_pattern: code_md_replace,
    channel_pattern: channel_md_replace,
}
channel_patterns = {
    cc_pattern: cc_html_replace,
    code_pattern: code_html_replace,
    pr_pattern: pr_html_user_mention_replace,
    bp_pattern: bp_replace,
}
